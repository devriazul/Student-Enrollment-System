                    ...
                    <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-right">
                                <a class="btn btn-info" href="students.php"><i class="icon-arrow-left icon-large"></i>
                                    Back</a>
						...
						?>
                            ...
                            <div class="span6">
                                ...
                                <hr>
                                Date Of Birth: <strong><?php echo $row['dob']; ?></strong>
                                <hr>
                                Address: <strong><?php echo $row['address']; ?></strong>
                                <hr>
                                Payment Status: <strong><?php echo $row['status']; ?></strong>
                                <hr>
                            </div>
                            <div class="span5">
                                Class: <strong><?php echo $row['class']; ?></strong>
                                <hr>
                                <?php 
						...
						$fee = $row1['fee'];
                                ...
                                Class Category: <strong><?php echo $category; ?></strong>
                                <hr>
                                Class Fee: <strong><?php echo $fee; ?></strong>
                                <hr>
                                Transport: <strong><?php echo $row['transport']; ?></strong>
                                <hr>
                                Route: <strong><?php echo $row['route']; ?></strong>
                                <hr>
